...
<div class="wrapper wbgcolor">
    <div class="w1200 personal">
        ...
        <div id="personal-left" class="personal-left">
            <ul>
                <li class="pleft-cur"><span><a href="userindex.jsp"><i class="dot dot1"></i>账户总览</a></span></li>
                <li><span><a style="font-size:14px;text-align:center;width:115px;padding-right:35px;" href="zijin.jsp">资金记录</a></span></li>
                <li><span><a style="font-size:14px;text-align:center;width:115px;padding-right:35px;" href="touzi.jsp">投资记录</a></span></li>
                <li><span><a style="font-size:14px;text-align:center;width:115px;padding-right:35px;" href="huikuan.jsp">回款计划</a></span></li>
                <li class=""><span><a href="disanfang.jsp"><i class="dot dot02"></i>开通第三方</a> </span> </li>
                <li><span><a href="chongzhi.jsp"><i class="dot dot03"></i>充值</a></span></li>
                <li class=""><span><a href="tixian.jsp"><i class="dot dot04"></i>提现</a></span></li>
                <li style="position:relative;" class=""> <span> <a href="hongbao.jsp"> <i class="dot dot06"></i> 我的红包 </a> </span> </li>
                <li class=""><span><a style="font-size:14px;text-align:center;width:115px;padding-right:35px;" href="history.jsp">兑换历史</a></span></li>
                <li style="position:relative;"> <span> <a href="xitong.jsp"><i class="dot dot08"></i>系统信息 </a> </span> </li>
                <li><span><a href="zhanghu.jsp"><i class="dot dot09"></i>账户设置</a></span></li>
            </ul>
        </div>
...
<div id="footer" class="ft">
    <div class="ft-inner clearfix">
        <div class="ft-helper clearfix">
            ...
            <dl>
                <dt>相关业务</dt>
                <dd><a href="../index/list.jsp">我要投资</a><a href="<%=path%>/index">我要借款</a></dd>
            </dl>
            <dl>
                <dt>帮助中心</dt>
