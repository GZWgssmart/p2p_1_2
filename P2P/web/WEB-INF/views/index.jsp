...
<header>
  <div class="header-top min-width">
    <div class="container fn-clear"> <strong class="fn-left">咨询热线：400-668-6698<span class="s-time">服务时间：9:00 - 18:00</span></strong>
      ...
      <ul class="fn-right header-top-ul">
        <li> <a href="<%=path%>/WEB-INF/views/index.jsp" class="app">返回首页</a> </li>
        <li>
  ...
  <div class="header min-width">
    <div class="container">
      <div class="fn-left logo"> <a class="" href="index.jsp"> <img src="<%=path%>/static/images/logo.png"  title=""> </a> </div>
      <ul class="top-nav fn-clear">
        <li class="on"> <a href="index.jsp">首页</a> </li>
        <li> <a href="index/list.jsp" class="">我要投资</a> </li>
        <li> <a href="<%=path%>/WEB-INF/views/index/help.jsp">安全保障</a> </li>
        <li class="top-nav-safe"> <a href="<%=path%>/WEB-INF/views/user/userindex.jsp">我的账户</a> </li>
        <li> <a href="<%=path%>/WEB-INF/views/index/about.jsp">关于我们</a> </li>
      </ul>
    </div>
  </div>
</header>
  ...
  <div class="new-announcement-content">
    <div id="scrollDiv">
      <ul style="margin-top: 0px;">
        <li><a class="black-link" href="index/ad1.jsp" target="_blank"> 2015年9月8日还款公告</a></li>
        <li><a class="black-link" href="index/ad1.jsp" target="_blank"> 2015年纪念抗日战争胜利放假公告</a></li>
      </ul>
    </div>
  </div>
  ...
  <div class="wrap">
    <div class="page-left fn-left">
      <div class="mod-borrow">
        ...
        <div class="bd">
          <div class="des"><span class="fn-left">期限1-29天，期限短，收益见效快</span><a href="index/list.jsp" class="fn-right">查看更多&gt;&gt;</a></div>
          <div class="borrow-list">
            <ul>
              <li>
                <div class="title"><a href="index/info.jsp" target="_blank"><i class="icon icon-zhai" title="债权贷"></i></a><a href="index/info.jsp" class="f18" title="金女士债权质押借款1万元" target="_blank">金女士债权质押借款1万元</a></div>
              ...
              <li>
                <div class="title"><a href="index/info.jsp" target="_blank"><i class="icon icon-zhai" title="债权贷"></i></a><a href="index/info.jsp" class="f18" title="周先生债权质押借款0.1万元" target="_blank">周先生债权质押借款0.1万元</a></div>
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tbody>
                  <tr>
      ...
      <div class="mod-borrow mrt20">
        ...
        <div class="bd">
          <div class="des"><span class="fn-left">期限1-12月，收益更高</span><a href="index/list.jsp" class="fn-right">查看更多&gt;&gt;</a></div>
          <div class="borrow-list">
            <ul>
              <li>
                <div class="title"><a href="#" target="_blank"><i class="icon icon-che" title="车易贷"></i></a><a href="index/info.jsp" class="f18" title="毕先生宝马320汽车质押贷款10万元" target="_blank">毕先生宝马320汽车质押贷款10万元</a></div>
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tbody>
                  <tr>
              ...
              <li>
                <div class="title"><a href="index/info.jsp" target="_blank"><i class="icon icon-che" title="车易贷"></i></a><a href="#" class="f18" title="王先生克莱斯勒300C汽车质押贷款15万元" target="_blank">王先生克莱斯勒300C汽车质押贷款15万元</a></div>
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tbody>
                  <tr>
      ...
      <div class="mod-borrow mrt20">
        ...
        <div class="bd">
          <div class="des"> <span class="fn-left">期限12-60月，打理更加容易</span><a href="index/list.jsp" class="fn-right">查看更多&gt;&gt;</a></div>
          <div class="borrow-list">
            <ul>
              <li>
                <div class="title"><a href="index/info.jsp" target="_blank"><i class="icon icon-che" title="车易贷"></i></a><a href="index/info.jsp" class="f18" title="朱先生比亚迪S6汽车抵押贷款4.5万元" target="_blank">朱先生比亚迪S6汽车抵押贷款4.5万元</a></div>
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tbody>
                  <tr>
              ...
              <li>
                <div class="title"><a href="index/info.jsp" target="_blank"><i class="icon icon-che" title="车易贷"></i></a><a href="index/info.jsp" class="f18" title="朱先生别克英朗汽车抵押贷款5万元" target="_blank">朱先生别克英朗汽车抵押贷款5万元</a></div>
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tbody>
                  <tr>
      ...
      <div class="mod-borrow mrt20">
        ...
        <div class="bd">
          <div class="des"><span class="fl">其他投资人折价转让，转让项目会随时更新，惊喜不断</span><a href="index/list.jsp" class="fn-right">查看更多&gt;&gt;</a></div>
          <div class="borrow-list">
            <ul>
              <li>
                <div class="title"><a href="index/info.jsp" target="_blank"><i class="icon icon-zhuan" title="债权转让"></i></a><a href="index/info.jsp" title="汪女士债权质押借款1万元" class="f18" target="_blank">汪女士债权质押借款1万元</a></div>
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tbody>
                  <tr>
    ...
    <div class="page-right fn-right" style="top: 0px;">
      <div class="mod-risk-tip"><i class="icon icon-tip"></i><a href="index.jsp" class="c-orange">收益与风险并存，请理性选择平台</a></div>
      <div class="mod mod-notice mrt20">
        <div class="hd">
          <h3>网站公告</h3>
          <a href="index.jsp" class="fn-right">更多&gt;</a></div>
        <div class="bd">
...
<div id="footer" class="ft">
  <div class="ft-inner clearfix">
    <div class="ft-helper clearfix">
      <dl>
        <dt>关于我们</dt>
        <dd><a href="index/about.jsp">公司简介</a><a href="index/managerTuandui.jsp">管理团队</a><a href="index/ad.jsp">网站公告</a></dd>
      </dl>
      <dl>
        <dt>相关业务</dt>
      ...
      <dl>
        <dt>帮助中心</dt>
        <dd><a href="index/help.jsp">新手入门</a><a href="user/userindex.jsp">我的账户</a><a href="index/list.jsp">债权转让</a></dd>
      </dl>
      <dl>
        <dt>联系我们</dt>
