...
public enum ControllerStatusEnum {
    ...
    MEDIA_SAVE_SUCCESS(525,"ok","媒体报道添加成功"),
    MEDIA_SAVE_FAIL(526,"error","媒体报道添加失败"),
    MEDIA_UPDATE_SUCCESS(527,"ok","媒体报道修改成功"),
    MEDIA_UPDATE_FAIL(528,"error","媒体报道修改失败"),
    MEDIA_DELETE_SUCCESS(529,"ok","媒体报道删除成功"),
    MEDIA_DELETE_FAIL(530,"error","媒体报道删除失败"),
    MEDIA_UPDATE_STATE_SUCCESS(531,"ok","修改状态成功"),
    MEDIA_UPDATE_STATE_FAIL(532,"error","修改状态失败"),
    DYNAMIC_SAVE_SUCCESS(533,"ok","公司动态添加成功"),
    DYNAMIC_SAVE_FAIL(534,"error","公司动态添加失败"),
    DYNAMIC_UPDATE_SUCCESS(535,"ok","公司动态修改成功"),
    DYNAMIC_UPDATE_FAIL(536,"error","公司动态修改失败"),
    DYNAMIC_DELETE_SUCCESS(537,"ok","公司动态删除成功"),
    DYNAMIC_DELETE_FAIL(538,"error","公司动态删除失败"),
    DYNAMIC_UPDATE_STATE_SUCCESS(539,"ok","修改状态成功"),
    DYNAMIC_UPDATE_STATE_FAIL(540,"error","修改状态失败"),
    HOME_SAVE_SUCCESS(541,"ok","首页信息添加成功"),
    HOME_SAVE_FAIL(542,"error","首页信息添加失败"),
    HOME_UPDATE_SUCCESS(543,"ok","首页信息修改成功"),
    HOME_UPDATE_FAIL(544,"error","首页信息修改失败"),
    HOME_DELETE_SUCCESS(545,"ok","首页信息删除成功"),
    HOME_DELETE_FAIL(546,"error","首页信息删除失败"),
