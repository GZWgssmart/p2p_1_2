...
<div id="footer" class="ft">
    <div class="ft-inner clearfix">
        <div class="ft-helper clearfix">
            <dl>
                <dt>关于我们</dt>
                <dd><a href="<%=path%>/page/about">公司简介</a><a href="<%=path%>/page/managerTuandui">管理团队</a><a href="<%=path%>/page/report">网站公告</a></dd>
            </dl>
            <dl>
                <dt>相关业务</dt>
                <dd><a href="<%=path%>/page/list">我要投资</a><a href="http://localhost:8080">我要借款</a></dd>
            </dl>
            <dl>
                <dt>帮助中心</dt>
                <dd><a href="<%=path%>/page/help">新手入门</a><a href="">我的账户</a><a href="<%=path%>/page/list">债权转让</a></dd>
            </dl>
            <dl>
                <dt>联系我们</dt>
