        ...
        <div class="ibox-content">
            <div class="panel panel-default">
                ...
                <div class="panel-body form-group" style="margin-bottom:0px;">
                    <label class="col-sm-1 control-label" style="text-align: right; margin-top:5px">收款人：</label>
                    <div class="col-sm-2">
...
<script src="<%=path%>/static/js/pageJs/sk.js"></script>
<script>
    function doSearch () {
        var uname=$('#uname').val();
        var rname=$('#rname').val();
        var options=$('#mytab').bootstrapTable('refresh', {
            url: '/sk/pager_criteria',
            query:{uname:uname,rname:rname}
        });
    }
</script>
</body>
