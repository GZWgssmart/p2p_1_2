...
<div class="page-container">
    <div class="text-c">
        ...
        <input type="text" name="" id="id" placeholder=" 资讯名称" style="width:250px" class="input-text">
        <button name="" id="id1" class="btn btn-success" type="submit"><i class="Hui-iconfont">&#xe665;</i> 搜资讯</button>
    </div>
