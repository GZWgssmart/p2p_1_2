...
<link href="<%=path%>/static/hui-jxs/lib/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css" />
</head>
<body>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="<%=path%>/static/hui-jxs/lib/My97DatePicker/4.8/WdatePicker.js"></script>
<script type="text/javascript" src="<%=path%>/static/hui-jxs/lib/jquery.validation/1.14.0/jquery.validate.js"></script>
<script type="text/javascript" src="<%=path%>/static/hui-jxs/lib/jquery.validation/1.14.0/validate-methods.js"></script>
<script type="text/javascript" src="<%=path%>/static/hui-jxs/lib/jquery.validation/1.14.0/messages_zh.js"></script>
<script type="text/javascript" src="<%=path%>/static/hui-jxs/lib/webuploader/0.1.5/webuploader.min.js"></script>
<script type="text/javascript" src="<%=path%>/static/hui-jxs/lib/ueditor/1.4.3/ueditor.config.js"></script>
<script type="text/javascript" src="<%=path%>/static/hui-jxs/lib/ueditor/1.4.3/ueditor.all.min.js"> </script>
<script type="text/javascript" src="<%=path%>/static/hui-jxs/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
...
$(function(){
	...
	var uploader = WebUploader.create({
		auto: true,
		swf: '<%=path%>/static/hui-jxs/lib/webuploader/0.1.5/Uploader.swf',
	
		// 文件接收服务端。
		server: '<%=path%>/static/hui-jxs/lib/webuploader/0.1.5/server/fileupload.php',
            ...
            if ( file.getStatus() === 'invalid' ) {
                ...
                uploader.makeThumb( file, function( error, src ) {
                    ...
                    if( isSupportBase64 ) {
                        ...
                        $.ajax('<%=path%>/static/hui-jxs/lib/webuploader/0.1.5/server/preview.php', {
                            method: 'POST',
                            data: src,
                            dataType:'json'
