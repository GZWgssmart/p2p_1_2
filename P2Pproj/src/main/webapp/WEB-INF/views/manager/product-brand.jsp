		...
		<table class="table table-border table-bordered table-bg table-sort">
			...
			<tbody>
				<tr class="text-c">
					...
					<td><img src="<%=path%>/static/hui-jxs/temp/brand/dongpeng.jpeg"></td>
					<td class="text-l"><img title="国内品牌" src="<%=path%>/static/hui-jxs/static/h-ui.admin/images/cn.gif"> 东鹏</td>
