...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <form method="post" id="dynamic_add" class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="col-sm-12 col-sm-offset-9">
                        <button class="btn btn-lg btn-primary " type="submit" onclick="return media_add();"><i class="fa fa-check"></i>&nbsp;<span class="bold">提交</span></button>
