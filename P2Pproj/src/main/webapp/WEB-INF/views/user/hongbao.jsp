                        ...
                        <li class="action">
                            <c:forEach items="${unuseList}" var="unuse">
                                <c:if test="${unuse.type==1}">
                                    ...
                                    <div class="copy">
                                    现金券
                                    <p>${unuse.uttime}<br>${unuse.tktime}</p><a href="<%=path%>/page/list/${unuse.kid}">转入余额</a>
                                    </div>
                                    </div>
                                </c:if>
                                <c:if test="${unuse.type==2}">
                                    ...
                                    <div class="copy">
                                    代金券
                                    <p>${unuse.uttime}<br>${unuse.tktime}</p><a href="<%=path%>/page/list/${unuse.kid}">立即使用</a>
                                    </div>
                                    </div>
                                </c:if>
                                <c:if test="${unuse.type==3}">
                                    ...
                                    <div class="copy">
                                    体验金
                                    <p>自${unuse.uttime}<br>起三天有效期</p><a href="<%=path%>/page/list/${unuse.kid}">立即使用</a>
                                    </div>
                                    </div>
                                </c:if>
