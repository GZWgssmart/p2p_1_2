            ...
            <div class="pmain-conmain" id="pmain-conmain">
                ...
                <div class="pmain-conmain2" style=" display:none;">
                    <div class="personal-main">
                        <div class="personal-pay">
                            <c:if test="${msg!=null}">
                                <font  color="#ff3300" size="5"  id="xs">${msg}</font>
                            </c:if>
                            <form id="form3" name="form2" method="post" action="<%=path%>/borrowapply/update">
                                <div class="pay-form">
                                    <ul>
                                        <li>
                                            <label >申请金额</label>
                                            <input type="text" class="pay-txt"  name="money" value="${borrowApply.money}" placeholder="请输入申请金额">
                                        </li>
                                        <li>
                                            <label >借款标种</label>
                                            <select  name="bzid" value="${borrowApply.bzid}" style="width: 270px;height: 40px">
                                                <option value="">请选择标种</option>
                                                <c:forEach items="${bzList}" var="d">
                                                    <option value="${d.bzid}">${d.bzname}</option>
                                                </c:forEach>
                                        ...
                                        <li>
                                            <label >借款类型</label>
                                            <select  name="lxid" value="${borrowApply.lxid}" style="width: 270px;height: 40px">
                                                <option value="">请选择借款类型</option>
                                                <c:forEach items="${jklxList}" var="d">
                                                    <option value="${d.lxid}">${d.lxname}</option>
                                                </c:forEach>
                                        ...
                                        <li>
                                            <label >借款期限</label>
                                            <input type="number" class="pay-txt"  name="term" value="${borrowApply.term}" placeholder="请输入借款期限">
                                        </li>
                                        <li>
                                            <label >资金用途</label>
                                            <input type="text" class="pay-txt"  name="mpurpose" value="${borrowDetail.mpurpose}" placeholder="请说明资金用途">
                                        </li>
                                        <li>
                                            <label >还款来源</label>
                                            <input type="text" class="pay-txt"  name="hksource" value="${borrowDetail.hksource}" placeholder="请输入还款来源">
                                        </li>
                                        <li>
                                            <label >年化收益</label>
                                            <input type="text" class="pay-txt"  name="nprofit" value="${borrowDetail.nprofit}" placeholder="请输入年化收益">
                                        </li>
                                        <li>
                                            <label >收益方式</label>
                                            <select  name="sid" style="width: 270px;height: 40px">
                                                <option value="">请选择还款类型</option>
                                                <c:forEach items="${swayList}" var="d">
                                                    <option value="${d.sid}">${d.way}</option>
                                                </c:forEach>
                                        ...
                                        <li>
                                            <label >借款人介绍</label>
                                            <textarea type="text" class="pay-txt" name="suggest" value="${borrowDetail.suggest}" placeholder="请输入借款人介绍" style="width: 570px;height: 50px;"></textarea>
                                        </li>
                                        <li>
                                            <label >项目描述</label>
                                            <textarea type="text" class="pay-txt"  name="xmdescrip" value="${borrowDetail.xmdescrip}" placeholder="请输入项目描述" style="width: 570px;height: 50px;"></textarea>
                                        </li>
                                        <li>
                                            <label >保障措施</label>
                                            <textarea type="text" class="pay-txt"  name="guarantee" value="${borrowDetail.guarantee}" placeholder="请输入保障措施" style="width: 570px;height: 50px;"></textarea>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
