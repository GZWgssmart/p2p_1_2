                ...
                <div class="pay-form">
                    ...
                    <ul>
                        <li>
                            ...
                            结果：&nbsp;&nbsp;&nbsp;&nbsp;
                            <c:if test="${borrowApply.state==0}">
                                <font size="5" color="red"> 恭喜您，借款审核通过了！</font>
                            </c:if>
                            <c:if test="${borrowApply.state==1}">
                        ...
                        <ul>
                            <li>
                                <a href="<%=path%>/borrowapply/update_page"> <input type="button" name="" value="修改借款信息" style="border:none;" class="btn-paykh"></a>
                            </li>
                        </ul>
                </div>
