            ...
            <div class="registerCont">
                <ul>
                    ...
                    <li>
                        ...
                        <input type="password" name="upwd" id="upwd" class="input _password" maxlength="24" tabindex="1">
                    ...
                    <li class="telNumber">
                        ...
                        <input type="text" class="input _phoneNum" id="phone" name="phone" onblur="checkPhone();" tabindex="1" maxlength="11">
                    </li>
                    <li class="telNumber">
                        <span class="dis">推荐码:</span>
                        <input id="tzm" type="text" name="tzm" class="input input1  _phonVerify" data-_id="phonVerify" tabindex="1">
                        <span id="ts" >可填也可不填</span>
                    </li>


                    <li>
                        <span class="dis">推荐人Id:</span>
                        <input id="tid" name="tid" type="text" class="input input1  _phonVerify" data-_id="phonVerify" tabindex="1">
                        <span id="t" >可填也可不填</span>
                    </li>


                    <li class="agree">
                        <input name="protocol" id="protocol" type="checkbox" value="" checked="checked">
                        我同意《<a href="#" target="_black">亿人宝注册协议</a>》 <span id="protocolAlt" data-info="请查看协议">请查看协议</span>
                    </li>
                    <li class="btn"><a href="javascript:void(0);" onclick="register();" class="radius1 _ajaxSubmit">注  册</a>
                    </li>
                </ul>
            </div>
        </form>
